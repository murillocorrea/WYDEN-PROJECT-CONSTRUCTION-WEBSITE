            ...
            if (Array.isArray(data) && data.length > 0) {
                ...
                chunks.forEach(chunk => {
                    ...
                    chunk.forEach(project => {
                        ...
                        console.log(`${BACKEND_URL}/storage/${project.image_path}`)
                        console.log(`assets/img/${project.image_path}`)
                        projectCard.innerHTML = `
                            <img src="assets/img/${project.image_path}" alt="image" class="projects__img">
